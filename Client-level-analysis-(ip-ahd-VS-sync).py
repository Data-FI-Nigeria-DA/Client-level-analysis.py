...
folder_Client = 'C:/Users/DELL/Documents/DataFi/Client_level_analysis/AHD_Client'
folder_centralsync = 'C:/Users/DELL/Documents/DataFi/Client_level_analysis/AHD_CS'


output_path = 'C:/Users/DELL/Documents/DataFi/Client_level_analysis/AHD_Client_level_analysis/Biu_GH_AHD_client_level_analysis_ACE1weekly.xlsx'
...
# Example usage
columns_to_clean = ['Age', 'Visitect CD4 Count']
...
def compare_documents(df1, df2):
    ...
    # Explicitly create the NDR_Patient_Identifier_Client and NDR_Patient_Identifier_Centralsync columns, return N/A if no match
    ...
    # columns to compare
    comparison_columns = [
        'State','LGA','Facility Name','Facility Id (Datim)','Patient ID','Hospital Number','Sex',
        'Date Of Birth (yyyy-mm-dd)','Age','Current Weight','Date of HIV diagnosis','ART start date',
        'Previous ART Status','Date of Previous ART Status','Current Status','Current Status Date',
        'Current Viral Load','Date of Current Viral Load Result','Viral Load Indication',
        'Date of Repeat Viral Load - Post EAC VL Sample collected (yyyy-','Repeat Viral load result (c/ml)- POST EAC',
        'Date of Repeat Viral load result- POST EAC VL','Category','Date of last visit','WHO Staging','Disease Conditions',
        'Presenting symptoms at screening','AHD Status','Visitect CD4 Count','Date of CD4 Count','CD4 type',
        'Cryptococcal Antigen','Date of Cryptococcal Antigen','LF LAM','Date of LF LAM','Serum crAg',
        'Date of Serum crAg','CSF crAg','Date of CSF crAg','Treatment Date'
    ]
