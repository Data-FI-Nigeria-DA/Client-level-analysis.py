...
output_path = 'C:/Users/DELL/Documents/DataFi/Client_level_analysis/ACE5_RADET_client_level_analysis.xlsx'
...
def compare_documents(df1, df2):
    ...
    comparison_columns = ['State', 'L.G.A', 'LGA Of Residence', 'Facility Name','Datim Id',  # 'Datim Id', # 
