...
folder_Client = 'C:/Users/DELL/Documents/DataFi/Client_level_analysis/PMTCT_Maternal_Client'
folder_centralsync = 'C:/Users/DELL/Documents/DataFi/Client_level_analysis/PMTCT_Maternal_CS'


output_path = 'C:/Users/DELL/Documents/DataFi/Client_level_analysis/PMTCT_Maternal Client level analysis/Biu_PMTCT_Maternal_client_level_analysis.xlsx'
...
def compare_documents(df1, df2):
    ...
    rename_dict2 = {
                        ...
                        'Result of first DNA PCR test' : 'Result of First DNA PCR test',
                        'Date first DNA PCR result was received': 'Date First DNA PCR result was received',
                        'Result of second DNA PCR test': 'Result of Second DNA PCR test',
                        'Date second DNA PCR result was received':'Date Second DNA PCR result was received',
                        'Date of third DNA PCR test sample collection':'Date of Third DNA PCR test sample collection',
                        'Result of third DNA PCR test':'Result of Third DNA PCR test'
                        }
    ...
    # columns to compare
    comparison_columns = [
        'Patient Id','State','LGA','Facility',"Mother''s Hospital Number","Mother''s Unique ID","Mother''s Date of Birth",'Age',
        'Marital Status','ANC Setting','Point of Entry','Modality','LMP Date','Gestational Age (Weeks) @ First ANC visit','Gravida',
        'Parity','Hepatitis B Test Result','Syphilis Test Result','Treated for Hepatitis B','Treated for Syphilis','TB screening Status',
        'TB screening Status','Type of HIV test',"Mother''s ART Start Date",'Timing of ART initiation in mother','Current Pregnancy Status',
        "Mother''s Current ART Status",'Visit Status',"Mother''s DSD Status",'Due Date for VL Sample collection @ 32 weeks',
        'Date for VL sample collection @ 32 weeks','VL result at 32-36 weeks GA','Current Viral load Result','Date of Current VL','Date of Delivery',
        'Place of Delivery','Mode of Delivery','Fetal outcome (Child status)',"Child''s hospital ID number",'Sex - Child','Birth Weight',
        'Date of ARV Prophylaxis Commencemment','Type of Prophylaxis (ePNP or regular)','Date of CTX (Cotrimoxazole)','Current infant feeding options',
        'Date of First DNA PCR Sample collection','Result of First DNA PCR test','Date First DNA PCR result was received',
        'Date of Second DNA PCR test sample collection','Result of Second DNA PCR test','Date Second DNA PCR result was received',
        'Date of Third DNA PCR test sample collection','Result of Third DNA PCR test','Date third DNA PCR result was received',
        'Date of fourth DNA PCR test sample collection','Result of fourth DNA PCR test','Date fourth DNA PCR result was received',
        'Date of confirmatory DNA PCR test sample collection','Result of confirmatory DNA PCR test','Date confirmatory DNA PCR result was received',
        'Date of Child Final Outcome test','Result (Child Final Outcome)',"Child''s ART Start Date",'Child Unique ID'
    ]
