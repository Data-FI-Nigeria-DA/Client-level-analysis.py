...
folder_Client = 'C:/Users/DELL/Documents/DataFi/Client_level_analysis/PrEP_Long. Client'
folder_centralsync = 'C:/Users/DELL/Documents/DataFi/Client_level_analysis/PrEP_Long. CS'


output_path = 'C:/Users/DELL/Documents/DataFi/Client_level_analysis/PrEP_Long. Client level analysis/GH-Minna_PrEP_Longitudinal_client_level_analysis.xlsx'
...
def compare_documents(df1, df2):
    ...
    #columns to compare
    comparison_columns = [
        'Patient Id','State','LGA','Facility Id','Facility Name','DATIM Id','Hospital Number','Sex','Age',
        'Date Of Birth (yyyy-mm-dd)','Marital Status','Pregnancy Status','LGA of Residence','State Of Residence',
        'Education','Occupation','Date Screened for PrEP','Eligible for PrEP','Offered PrEP','Willing to Commence PREP',
        'Accepted to Commence PrEP','Reasons for Declining PrEP','Weight','Height','Pulse','Temperature','Respiratory Rate',
        'Systolic BP','diastolic BP','History of Drug-Drug Interactions','Visit Type','Date Prep Given','PrEP Type',
        'PrEP Regimen','Regimen Duration / Days of Refill','Other Drugs','Adherence Level','Next Appointment',
        'Risk Reduction Services','Noted Side Effects','Date of Hepatitis Test','Hepatitis Result','Date ot Syphilis Test',
        'Syphilis Result','Date of HIV Test','HIV Test Result','Date of Syndromic STI','Syndromic STI Screening',
        'Date of  Liver Function Test','Liver Function Test Result','Date of  HBsAG','HBsAG Result','Date of  HB/PCV',
        'HB/PCV Result','Date of  WBC','WBC Result','Urinalysis','Date of Urinalysis','Date of Current AST','Current AST',
        'Date of Current Creatinine','Current Creatinine','Date of Current Chest Xray','Current Chest Xray','Date of Current Lipid Profile',
        'Current Lipid Profile','PrEP Discontinuation Type','Reasons for discontinuation/Stopped','Date of Discontinuation/stopped',
        'Date Of HIV Enrollment (yyyy-mm-dd)','Other Tests Done','Date of Other test Done','Status','Date of Adverse Events','Adverse Events','Notes'
    ]
