...
folder_Client = 'C:/Users/DELL/Documents/DataFi/Client_level_analysis/Laboratory Client'
folder_centralsync = 'C:/Users/DELL/Documents/DataFi/Client_level_analysis/Laboratory CS'

output_path = 'C:/Users/DELL/Documents/DataFi/Client_level_analysis/Laboratory Client level analysis/GH-Minna_Laboratory_client_level_analysis.xlsx'
...
def compare_documents(df1, df2):
    ...
    rename_dict2 = {'Date  Result Received  (yyyy-mm-dd)' : 'Date Result Received  (yyyy-mm-dd)'
                        }
    ...
    # columns to compare
    comparison_columns = [
        'Facility Name','DATIM Id','Patient Id','Test','Date Sample Collected (yyyy-mm-dd)','Result','Date Result Received  (yyyy-mm-dd)'
    ]
