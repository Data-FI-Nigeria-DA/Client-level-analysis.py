...
folder_Client = 'C:/Users/DELL/Documents/DataFi/Client_level_analysis/Pharmacy Client'
folder_centralsync = 'C:/Users/DELL/Documents/DataFi/Client_level_analysis/Pharmacy CS'

output_path = 'C:/Users/DELL/Documents/DataFi/Client_level_analysis/Pharmacy Client level analysis/UMTH_Pharmacy_client_level_analysis.xlsx'
...
def compare_documents(df1, df2):
    ...
    rename_dict2 = {'DATIM Id' : 'Datim Id',
                   'Hospital Num' : 'Hospital Number',
                   'Regimens(Include supported Drugs)' : 'Regimens'
                        }
    ...
    # columns to compare
    comparison_columns = [
        'Facility Name','Datim Id','Patient Id','Hospital Number',
        'Date Visit(yyyy-mm-dd)','Regimen Line','Regimens','Refill Period',
        'MMD_Type','Next Appointment (yyyy-mm-dd)','DSD Model'
    ]
