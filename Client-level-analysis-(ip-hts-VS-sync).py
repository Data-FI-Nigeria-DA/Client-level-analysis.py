...
folder_Client = 'C:/Users/DELL/Documents/DataFi/Client_level_analysis/RADET'#HTS Client'
folder_centralsync = 'C:/Users/DELL/Documents/DataFi/Client_level_analysis/Centralsync'#HTS CS'


output_path = 'C:/Users/DELL/Documents/DataFi/Client_level_analysis/HTS Client level analysis/ACE-2_HTS_client_level_analysisACE1weekly.xlsx'
...
def compare_documents(df1, df2):
    ...
    rename_dict2 = {
                    ...
                    'Pregnancy/Breastfeeding Status': 'Pregnancy Status'}
    ...
    # columns to compare
    comparison_columns = [
        'Facility Id (Datim)','Facility','Patient Id','Client Code','First Name','Surname','Other Names',
        'Sex','Target Group','Age','Date Of Birth (yyyy-mm-dd)','Phone Number','Marital Status','Client Address',
        'LGA of Residence','State Of Residence','Education','Occupation','Date of Visit (yyyy-mm-dd)',
        'First Time Visit','Index Client','Previously Tested','Counseling Type','Pregnancy Status','Index Type',
        'Recency Id','Recency Test Type','Recency Test Date (yyyy-mm-dd)','Recency Interpretation',
        'Final Recency Result','Recency Viral Load Sample Collection Date','Recency Viral Load Confirmation Result',
        'Recency Viral Load Result Received Date (yyyy-mm-dd)','Modality','Syphilis Test Result','Hepatitis B Result',
        'Hepatitis C Result','CD4 Type','CD4 Test Result','Final HIV Test Result','Date Of HIV Testing (yyyy-mm-dd)',
        'Prep Offered','Prep Accepted','Number of condoms given','HTS Latitude','HTS Longitude','HTS Count'
    ]
